 ...
 *
 * NOTE: The JSON Schemas for bash are discovered at runtime from the MCP toolhost
...
// Gateway-native tool: long-term memory (memorize / delete). Enabled when memory service is active.
