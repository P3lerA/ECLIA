...
const EXEC_TOOL_DEF = {
  ...
  description: "Execute a command on this machine (POSIX shell: macOS/Linux). Prefer cmd+args. For large/binary outputs, write files to $ECLIA_ARTIFACT_DIR (provided automatically). Avoid printing huge base64 blobs; decode to a file instead. Files created there will be returned as artifacts (downloadable). Returns stdout/stderr/exitCode.",
  inputSchema: {
    type: "object",
    properties: {
      cmd: {
